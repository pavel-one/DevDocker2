...
| Полки | рейки из той же трубы 25×25 |
| Просвет между рейками | ~**80 мм** (6 реек на полку) — свет проходит на нижние полки |
...
полки (количество реек подбирается автоматически под равные зазоры).
